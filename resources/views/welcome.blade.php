...
<html lang="es">
    <head>
        ...
        <title>Para Darlyn Vanesa Usuga</title>
        ...
        <div class="site-shell">
            <section class="welcome-screen" id="welcome-screen" aria-labelledby="welcome-title">
                ...
                <div class="welcome-copy">
                    <p class="eyebrow">hecho con cariño · para Darlyn</p>
                    <h1 id="welcome-title">Darlyn<br><em>esto es para ti.</em></h1>
                    <p class="welcome-subtitle">Hay personas que merecen un detalle bonito<br class="desktop-only"> simplemente por ser como son.</p>
                    <div class="intro-envelope" aria-hidden="true"><span class="intro-flap"></span><span class="intro-heart">♥</span><span class="intro-letter">para Darlyn</span></div>
            ...
            <main class="memory-page" id="memory-page">
                <header class="topbar">
                    ...
                    <span class="topbar-date">para Darlyn <span>♡</span></span>
                </header>

                <section class="hero-section reveal" id="top">
                    <div class="hero-copy" id="historia"><p class="eyebrow">capítulo uno / un detalle</p><h2>Qué bonito<br>encontrar a <em>alguien como tú.</em></h2><p class="hero-text">No hace falta una gran ocasión para decirle a alguien que ilumina los espacios, que su forma de ser se nota y que merece cosas bonitas.</p><div class="darlyn-words" aria-label="Palabras para Darlyn"><span>auténtica</span><span>valiente</span><span>luminosa</span><span>soñadora</span><span>especial</span></div></div>
                ...
                <section class="constellation-section reveal"><p class="eyebrow">tu propia constelación</p><h2>Hay personas que<br><em>parecen estrellas.</em></h2><div class="constellation" aria-label="Constelación de Darlyn"><span class="star star-a" data-star="Tu forma de ser ilumina más de lo que imaginas.">✦</span><span class="star star-b" data-star="Mereces que la vida te sorprenda bonito.">✦</span><span class="star star-c" data-star="Tu alegría tiene una luz muy especial.">✦</span><span class="star star-d" data-star="Nunca olvides todo lo valiosa que eres.">✦</span><span class="star star-e" data-star="Lo mejor todavía puede estar por comenzar.">✦</span><span class="constellation-name">Darlyn<br><em>Vanesa Usuga</em></span><p class="star-message" id="star-message">Toca una estrella</p></div></section>
                ...
                <section class="night-section reveal"><div class="night-sky"><span>✦</span><span>✧</span><span>·</span><span>✦</span><span>✧</span><span>·</span><span>✦</span><span>✧</span><span>·</span><h2>Darlyn, nunca olvides<br><em>lo especial que eres.</em></h2></div><p class="night-typed" id="night-typed"></p></section>
                ...
                <footer class="site-footer final-section"><p class="footer-mark">a<span>·</span>m</p><p class="final-name">Darlyn Vanesa Usuga</p><p>Que nunca te falten razones para sonreír.</p><p class="footer-small">hecho especialmente para ti</p><div class="petals" aria-hidden="true"><span>✦</span><span>✿</span><span>♥</span><span>✧</span><span>✽</span></div></footer>
            </main>
        </div>
